...
#        mytemplateDir = "{1}/{0:.0f}TeV".format(self.sqrts.self.templateDir)
        ...
        signalTemplates_Nominal = "{0}_templates_Nominal.root".format(self.appendName)
        templateSigName = "{0}/{1}".format(mytemplateDir,signalTemplates_Nominal)
        ...
        signalTemplates_ScaleResUp = "{0}_templates_ResUp.root".format(self.appendName)
        templateSigName = "{0}/{1}".format(mytemplateDir,signalTemplates_ScaleResUp)
        print templateSigName
        sigTempFile_ResUp = ROOT.TFile(templateSigName)
        Sig_T_1_ResUp = sigTempFile_ResUp.Get("T_3D_1")
        Sig_T_2_ResUp = sigTempFile_ResUp.Get("T_3D_2")
        Sig_T_3_ResUp = sigTempFile_ResUp.Get("T_3D_3")
        Sig_T_4_ResUp = sigTempFile_ResUp.Get("T_3D_4")
        Sig_T_5_ResUp = sigTempFile_ResUp.Get("T_3D_5")
        Sig_T_6_ResUp = sigTempFile_ResUp.Get("T_3D_6")
        Sig_T_7_ResUp = sigTempFile_ResUp.Get("T_3D_7")
        Sig_T_8_ResUp = sigTempFile_ResUp.Get("T_3D_8")
        Sig_T_9_ResUp = sigTempFile_ResUp.Get("T_3D_9")
        Sig_T_1_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_1_ResUp".format(self.sqrts,self.appendName))
        Sig_T_2_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_2_ResUp".format(self.sqrts,self.appendName))
        Sig_T_3_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_3_ResUp".format(self.sqrts,self.appendName))
        Sig_T_4_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_4_ResUp".format(self.sqrts,self.appendName))
        Sig_T_5_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_5_ResUp".format(self.sqrts,self.appendName))
        Sig_T_6_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_6_ResUp".format(self.sqrts,self.appendName))
        Sig_T_7_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_7_ResUp".format(self.sqrts,self.appendName))
        Sig_T_8_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_8_ResUp".format(self.sqrts,self.appendName))
        Sig_T_9_ResUp.SetName("T_ZZ_{0:.0f}_{1}_3D_9_ResUp".format(self.sqrts,self.appendName))
        signalTemplates_ScaleResDown = "{0}_templates_ResDown.root".format(self.appendName)
        templateSigName = "{0}/{1}".format(mytemplateDir,signalTemplates_ScaleResDown)
        sigTempFile_ResDown = ROOT.TFile(templateSigName)
        Sig_T_1_ResDown = sigTempFile_ResDown.Get("T_3D_1")
        Sig_T_2_ResDown = sigTempFile_ResDown.Get("T_3D_2")
        Sig_T_3_ResDown = sigTempFile_ResDown.Get("T_3D_3")
        Sig_T_4_ResDown = sigTempFile_ResDown.Get("T_3D_4")
        Sig_T_5_ResDown = sigTempFile_ResDown.Get("T_3D_5")
        Sig_T_6_ResDown = sigTempFile_ResDown.Get("T_3D_6")
        Sig_T_7_ResDown = sigTempFile_ResDown.Get("T_3D_7")
        Sig_T_8_ResDown = sigTempFile_ResDown.Get("T_3D_8")
        Sig_T_9_ResDown = sigTempFile_ResDown.Get("T_3D_9")
        Sig_T_1_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_1_ResDown".format(self.sqrts,self.appendName))
        Sig_T_2_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_2_ResDown".format(self.sqrts,self.appendName))
        Sig_T_3_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_3_ResDown".format(self.sqrts,self.appendName))
        Sig_T_4_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_4_ResDown".format(self.sqrts,self.appendName))
        Sig_T_5_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_5_ResDown".format(self.sqrts,self.appendName))
        Sig_T_6_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_6_ResDown".format(self.sqrts,self.appendName))
        Sig_T_7_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_7_ResDown".format(self.sqrts,self.appendName))
        Sig_T_8_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_8_ResDown".format(self.sqrts,self.appendName))
        Sig_T_9_ResDown.SetName("T_ZZ_{0:.0f}_{1}_3D_9_ResDown".format(self.sqrts,self.appendName))


        signalTemplates_ScaleResUp = "{0}_templates_ScaleUp.root".format(self.appendName)
        templateSigName = "{0}/{1}".format(mytemplateDir,signalTemplates_ScaleResUp)
        sigTempFile_ScaleUp = ROOT.TFile(templateSigName)
        Sig_T_1_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_1")
        Sig_T_2_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_2")
        Sig_T_3_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_3")
        Sig_T_4_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_4")
        Sig_T_5_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_5")
        Sig_T_6_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_6")
        Sig_T_7_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_7")
        Sig_T_8_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_8")
        Sig_T_9_ScaleUp = sigTempFile_ScaleUp.Get("T_3D_9")
        Sig_T_1_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_1_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_2_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_2_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_3_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_3_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_4_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_4_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_5_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_5_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_6_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_6_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_7_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_7_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_8_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_8_ScaleUp".format(self.sqrts,self.appendName))
        Sig_T_9_ScaleUp.SetName("T_ZZ_{0:.0f}_{1}_3D_9_ScaleUp".format(self.sqrts,self.appendName))
        signalTemplates_ScaleResDown = "{0}_templates_ScaleDown.root".format(self.appendName)
        templateSigName = "{0}/{1}".format(mytemplateDir,signalTemplates_ScaleResDown)
        sigTempFile_ScaleDown = ROOT.TFile(templateSigName)
        Sig_T_1_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_1")
        Sig_T_2_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_2")
        Sig_T_3_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_3")
        Sig_T_4_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_4")
        Sig_T_5_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_5")
        Sig_T_6_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_6")
        Sig_T_7_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_7")
        Sig_T_8_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_8")
        Sig_T_9_ScaleDown = sigTempFile_ScaleDown.Get("T_3D_9")
        Sig_T_1_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_1_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_2_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_2_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_3_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_3_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_4_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_4_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_5_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_5_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_6_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_6_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_7_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_7_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_8_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_8_ScaleDown".format(self.sqrts,self.appendName))
        Sig_T_9_ScaleDown.SetName("T_ZZ_{0:.0f}_{1}_3D_9_ScaleDown".format(self.sqrts,self.appendName))

        Sig_T_1_ResUp.Add(Sig_T_1_ScaleUp,1.)
        Sig_T_1_ResUp.Add(Sig_T_1,-1.)
        Sig_T_2_ResUp.Add(Sig_T_2_ScaleUp,1.)
        Sig_T_2_ResUp.Add(Sig_T_2,-1.)
        Sig_T_3_ResUp.Add(Sig_T_3_ScaleUp,1.)
        Sig_T_3_ResUp.Add(Sig_T_3,-1.)
        Sig_T_4_ResUp.Add(Sig_T_4_ScaleUp,1.)
        Sig_T_4_ResUp.Add(Sig_T_4,-1.)
        Sig_T_5_ResUp.Add(Sig_T_5_ScaleUp,1.)
        Sig_T_5_ResUp.Add(Sig_T_5,-1.)
        Sig_T_6_ResUp.Add(Sig_T_6_ScaleUp,1.)
        Sig_T_6_ResUp.Add(Sig_T_6,-1.)
        Sig_T_7_ResUp.Add(Sig_T_7_ScaleUp,1.)
        Sig_T_7_ResUp.Add(Sig_T_7,-1.)
        Sig_T_8_ResUp.Add(Sig_T_8_ScaleUp,1.)
        Sig_T_8_ResUp.Add(Sig_T_8,-1.)
        Sig_T_9_ResUp.Add(Sig_T_9_ScaleUp,1.)
        Sig_T_9_ResUp.Add(Sig_T_9,-1.)

        Sig_T_1_ResDown.Add(Sig_T_1_ScaleDown,1.)
        Sig_T_1_ResDown.Add(Sig_T_1,-1.)
        Sig_T_2_ResDown.Add(Sig_T_2_ScaleDown,1.)
        Sig_T_2_ResDown.Add(Sig_T_2,-1.)
        Sig_T_3_ResDown.Add(Sig_T_3_ScaleDown,1.)
        Sig_T_3_ResDown.Add(Sig_T_3,-1.)
        Sig_T_4_ResDown.Add(Sig_T_4_ScaleDown,1.)
        Sig_T_4_ResDown.Add(Sig_T_4,-1.)
        Sig_T_5_ResDown.Add(Sig_T_5_ScaleDown,1.)
        Sig_T_5_ResDown.Add(Sig_T_5,-1.)
        Sig_T_6_ResDown.Add(Sig_T_6_ScaleDown,1.)
        Sig_T_6_ResDown.Add(Sig_T_6,-1.)
        Sig_T_7_ResDown.Add(Sig_T_7_ScaleDown,1.)
        Sig_T_7_ResDown.Add(Sig_T_7,-1.)
        Sig_T_8_ResDown.Add(Sig_T_8_ScaleDown,1.)
        Sig_T_8_ResDown.Add(Sig_T_8,-1.)
        Sig_T_9_ResDown.Add(Sig_T_9_ScaleDown,1.)
        Sig_T_9_ResDown.Add(Sig_T_9,-1.)
...
#        Sig_T_1_ResUp_hist = ROOT.RooDataHist ("T_1_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_1)
#        Sig_T_2_ResUp_hist = ROOT.RooDataHist ("T_2_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_2)
#        Sig_T_3_ResUp_hist = ROOT.RooDataHist ("T_3_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_3)
#        Sig_T_4_ResUp_hist = ROOT.RooDataHist ("T_3_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_4)
#        Sig_T_5_ResUp_hist = ROOT.RooDataHist ("T_5_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_5)
#        Sig_T_6_ResUp_hist = ROOT.RooDataHist ("T_6_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_6)
#        Sig_T_7_ResUp_hist = ROOT.RooDataHist ("T_7_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_7)
#        Sig_T_8_ResUp_hist = ROOT.RooDataHist ("T_8_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_8)
#        Sig_T_9_ResUp_hist = ROOT.RooDataHist ("T_9_ResUp_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_9)
#        Sig_T_1_ResDown_hist = ROOT.RooDataHist ("T_1_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_1)
#        Sig_T_2_ResDown_hist = ROOT.RooDataHist ("T_2_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_2)
#        Sig_T_3_ResDown_hist = ROOT.RooDataHist ("T_3_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_3)
#        Sig_T_4_ResDown_hist = ROOT.RooDataHist ("T_3_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_4)
#        Sig_T_5_ResDown_hist = ROOT.RooDataHist ("T_5_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_5)
#        Sig_T_6_ResDown_hist = ROOT.RooDataHist ("T_6_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_6)
#        Sig_T_7_ResDown_hist = ROOT.RooDataHist ("T_7_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_7)
#        Sig_T_8_ResDown_hist = ROOT.RooDataHist ("T_8_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_8)
#        Sig_T_9_ResDown_hist = ROOT.RooDataHist ("T_9_ResDown_hist","", ROOT.RooArgList(D1,D2,D3),Sig_T_9)
        ...
        templateBkgName = "{0}/{1}".format(mytemplateDir,bkgTemplates_Nominal)
