...
//			if(t==2) hsig[kNumTemplates * f + t]->Scale( 0.093702 );
			if(t==2) hsig[kNumTemplates * f + t]->Scale( hsig[kNumTemplates * f + 0]->Integral() / hsig[kNumTemplates * f + t]->Integral() );
...
void modifyTemplates_Z4lBuilder_YieldNorm(TString dir, int processSig=1, int processBkg=1){
